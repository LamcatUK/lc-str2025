...
function remove_featured_image_support_for_sidebar_template() {
    ...
    if ( is_admin() ) {
        ...
        if ( $post_id ) {
            ...
            if ( 'page-templates/sidebar-page.php' === $template
