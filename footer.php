    ...
    <div class="container-xl">
        <div class="row py-3 py-lg-4 gy-4">
            <div class="col-12 col-xl-5 order-4 order-xl-1">
                ...
                <div class="fs-200 text-center text-xl-start">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Amet in consequuntur inventore sunt molestiae fugiat dolorem assumenda suscipit saepe quidem.</div>
            </div>
