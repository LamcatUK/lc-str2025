...
$background = get_field( 'bg_colour' ) ? get_field( 'bg_colour' ) : 'white';
...
if ( 'page-templates/sidebar-page.php' === $template_slug ) {
    $background = 'grey-100 mt-5';
}

?>
<section class="insights py-6 bg-<?= esc_attr( $background ); ?>">
    <div class="container-xl">
        ...
        <div class="insights__grid mb-5" data-aos="fadein">
            ...
            while ( $q->have_posts() ) {
                ...
                ?>
                <a class="insights__card" href="<?= esc_url( get_the_permalink() ); ?>">
                    <div>
                        ...
                        if ( true === $first ) {
                            ?>
                            <p class="fs-300"><?= wp_kses_post( wp_trim_words( get_the_content(), $length ) ); ?></p>
                            <?php
                            $first = false;
                        }
                        ?>
